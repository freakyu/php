  ...
  <body height="100" background="gambar/b.png">
    ...
    <div class="container mb-6" >
      ...
      <div class="row row-cols-1 row-cols-md-3">
        <div class="col mb-4">
          <div class="card">
            <img height="200" src="gambar/churros.jpeg" class="card-img-top" alt="gambar/churros">
            <div class="card-body">
              <h5 class="card-title" style="color :chocolate;">C H U R R O S</h5>
              <p class="card-text">Churros adalah makanan ringan bagi orang Indonesia, karena proses pembuatan yang gampang.
                  Cocok banget nih buat kamu yang lagi gabut. Cus bisa dicoba!</p>
              <a href="churros.php" class="btn btn-outline-success">Lebih lanjut</a>
            </div>
          </div>
        </div>
        <div class="col mb-4 mr-5">
          <div class="card">
            <img src="gambar/lemontea.jpeg" class="card-img-top" alt="gambar/lemontea">
            <div class="card-body">
              <h5 class="card-title" style="color :chocolate;">L E M M O N | T E A</h5>
              <p class="card-text">Anda ingin diet, tapi bingung nih mulai darimana? Beli obat diet, harganya mahal! Nah lemmon tea
                  mungkin bisa menjadi jawaban untuk diet murah sehat ya friends.. Simple banget bund!</p>
              <a href="Lemontea.php" class="btn btn-outline-success" >Lebih lanjut</a>
            </div>
          </div>
        </div>
      </div>
