...
<html lang="en">
  ...
  <body background="images/blog-img.jpg">
    <!-- Start Main Top -->
    ...
    <div class="kotak">
      <form action="index.php" method="POST">
        <table>
          <tr>
            <td>
        <label for="nama" style="color: yellow;"><b>Name</b></label>
        <input type="text" name="nama" class="form-control" id="nama" required="" placeholder="Enter your name">
           </td>
          </tr>
           <tr>
             <td>
            <label for="isi" style="color: yellow;"><b>Content</b></label>
            <textarea id="isi" name="isi"></textarea>
             </td>
           </tr>
       </table>
      <br/>
      <input type="submit" class="btn-warning" name="simpan" value="simpan">
    </form>
    </div>
  </div>

  <script type="text/javascript">CKEDITOR.replace('isi',{
    width: "650px",
  ...
  filebrowserUploadMethod: "form"
    ...
    <!-- Start Footer  -->
    <footer class="mt-5">
      <div class="tengah  btn-secondary">
    ...
    <!-- End Footer  -->
     ...
     <!-- Start copyright  -->
     <div class="wrapper btn-secondary">
